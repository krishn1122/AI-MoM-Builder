...
class MOMBuilder {
    ...
    getFileIcon(fileType) {
        switch (fileType) {
            ...
            case 'docx':
                return `<img src="https://img.icons8.com/external-fauzidea-flat-fauzidea/64/external-docx-file-file-extension-fauzidea-flat-fauzidea.png" alt="DOCX" class="h-12 w-12">`;
            case 'txt':
                return `<img src="https://img.icons8.com/external-fauzidea-flat-fauzidea/64/external-txt-file-file-extension-fauzidea-flat-fauzidea.png" alt="TXT" class="h-12 w-12">`;
            default:
